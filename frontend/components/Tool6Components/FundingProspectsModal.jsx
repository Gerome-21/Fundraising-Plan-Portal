...
const FundingProspectsModal = ({ isOpen, onClose, onSave, initialComment, position }) => {
    ...
    <div className="fixed inset-0 z-[1000]" style={{ pointerEvents: 'none' }}>
      ...
      >
        ...
        <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200 bg-gray-50 rounded-t-lg">
          <h3 className="text-sm font-semibold text-gray-700">Funding Prospects</h3>
          <button
            onClick={onClose}
...
export default FundingProspectsModal